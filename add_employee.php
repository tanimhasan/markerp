...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $result = mysqli_query($con, "SELECT * FROM employee where phone='$phone'");
    $num_rows = mysqli_num_rows($result);


    if ($num_rows > 0) {
        echo '<script type="text/javascript">';
        echo 'setTimeout(function () { swal.fire("ERROR!","Phone number already exists!","error");';
        echo '}, 500);</script>';
    } else {
        if (mysqli_query($con, "INSERT INTO employee (`name`,`phone`,`email`,`designation`,`nid`,`driving_license`,`salary`,`address`) VALUE ('$name','$phone','$email','$designation','$nid','$driving_license','$salary','$address')")) {
            // insert access log in to data base
            include('my_function.php');
            $user_email = $_SESSION['email'];
            $user_id = getIdByEmail($user_email);
            insertActivityLog($user_id,'Added New Employee ' . $name);
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <form role="form" id="quickForm" method="post" action="add_employee.php">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="exampleInputLicense">Driving License <small>[If Any]</small></label>
                            ...
                            <div class="card-footer">
                                ...
                                <button type="submit" id="add_employee" class="btn btn-primary"><i class="fa fa-check-circle"></i> Add Employee</button>
                            </div>
                        </form>
