                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <button type="button" onclick="location.href = 'add_production.php';"
                                    class="btn btn-primary float-right"><i class='fas fa-plus-circle'></i> Add Production
                            </button>
                            <h3 class="card-title">All Production Information</h3>
                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped" style="width:100%">
                                ...
                                $sql = "SELECT * FROM production ORDER BY production_id DESC";
                                ...
                                while ($row = mysqli_fetch_array($result)) {
                                    ...
                                    if ($user_type=='admin') {
                                        echo "<td><a class='btn btn-primary'  href=\"edit_production.php?id=" . $row['production_id'] . "\" ><i class='fas fa-edit'></i></a> ";
                                        echo "<a class='confirmation btn btn-danger'  href=\"delete_production.php?id=" . $row['production_id'] . "\" ><i class='fas fa-trash'></i></a></td>";
                                    }
