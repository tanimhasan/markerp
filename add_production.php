...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $result = mysqli_query($con, "SELECT * FROM production WHERE emp_id='$emp_id' AND lot_no='$lot_no' AND item_name='$item_name' AND qty='$qty' AND price='$price'");
    $num_rows = mysqli_num_rows($result);


        $get_amount=getBalance($emp_id);
        $updated_amount=$get_amount+$total_price;
        mysqli_query($con,"UPDATE employee SET balance='$updated_amount' WHERE employee_id='$emp_id'");
        mysqli_query($con,"INSERT INTO salary (emp_id,salary,month,type,date) VALUES ('$emp_id','$total_price','$month','Credit','$date')");

        if (mysqli_query($con, "INSERT INTO production (`emp_id`,`lot_no`,`item_name`,`qty`,`price`,`total_price`,`date`) VALUE ('$emp_id','$lot_no','$item_name','$qty','$price','$total_price','$date')")) {
            // insert access log in to data base
            $user_email = $_SESSION['email'];
            $user_id = getIdByEmail($user_email);
            insertActivityLog($user_id,'Added Production ' . $item_name);
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <h3 class="card-title">Add Production information</h3>

                        </div>


                        <form role="form" id="quickForm" method="post" action="add_production.php">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="exampleInputPhone">Art. No</label>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                <label for="exampleInputPhone">Select Item</label>
                            ...
                            <div class="card-footer">
                                ...
                                <button type="submit" id="add_production" class="btn btn-primary"><i class="fa fa-check-circle"></i> Add Production
                                </button>
                            </div>
                        </form>
...
<script type="text/javascript">
    ...
    $(document).on('click', '#add_production', function (e) {
