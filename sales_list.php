                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <button type="button" onclick="location.href = 'add_sales.php';"
                                    class="btn btn-primary float-right"><i class='fas fa-plus-circle'></i> Add Sales
                            </button>
                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped" style="width:100%">
                                ...
                                while ($row = mysqli_fetch_array($result)) {
                                    ...
                                    {
                                        echo "<td>  <button type='button' class='btn btn-block bg-gradient-gray btn-xs'  data-toggle=\"modal\" data-target=\"#paymentModal\" data-id='" . $row['invoice_id'] . "'  data-due='" . $due. "'>Add Payment</button></td>";
                                    ...
                                    if ($user_type == 'admin') {
                                        ...
                                        echo "<td><a class='btn btn-primary'  href=\"sales_details.php?id=" . $row['invoice_id'] ."&discount=".$row['discount']."&paid=".$row['paid_amount']."&notes=".$row['notes']. "\" ><i class='fas fa-eye'></i></a>  ";
                                        echo "<a class='confirmation btn btn-danger'  href=\"delete_sales.php?id=" . $row['invoice_id'] . "\" ><i class='fas fa-trash'></i></a></td>";
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form role="form" method="POST" id="due_form" action="add_sales_payment.php">
                    <input type="hidden" name="_token" value="">

                    <div class="form-group">
                        <label class="control-label">Invoice Number</label>
                        <div>
                            <input type="text" id="id" class="form-control input-lg" name="invoice_id" readonly>
                        </div>
                    </div>
