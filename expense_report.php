                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="form-group">
                                ...
                                <form action="expense_report_print.php" id="quickForm" method="post" target="_blank">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <!-- text input -->
                                            <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <!-- text input -->
                                            <div class="form-group">
                                                <label for="exampleInputVehicle">Select Expense</label>
                                                <select class="form-control select2" name="category_id">
                                                    <option disabled selected hidden>Select Expense</option>
