                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <button type="button" onclick="location.href = 'add_expense_category.php';"
                                    class="btn btn-primary float-right"><i class='fas fa-plus-circle'></i> Add Expense Category
                            </button>
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                while ($row = mysqli_fetch_array($result)) {
                                    ...
                                    if ($user_type == 'admin') {
                                        ...
                                        echo "<td><a class='btn btn-primary'  href=\"edit_expense_category.php?id=" . $row['category_id'] . "\" ><i class='fas fa-edit'></i></a></td>";
                                    }
