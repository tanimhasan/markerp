                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <button type="button" onclick="location.href = 'add_account.php';"
                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped" style="width:100%">
                                ...
                                $sql = "SELECT * FROM banking ORDER BY account_id DESC";
                                ...
                                while ($row = mysqli_fetch_array($result)) {
                                    ...
                                    echo "<td>" . typeName($row['account_type']) . "</td>";
                                    echo "<td>" . $row['account_number'] . "</td>";
                                    echo "<td>" . $row['bank_name'] . "</td>";
                                    echo "<td>" . $row['bank_address'] . "</td>";
                                    echo "<td>" . number_format($row['balance'],2) . "</td>";

                                    echo "<td><a class='btn btn-primary'  href=\"edit_bank_account.php?id=" . $row['account_id'] . "\" ><i class='fas fa-edit'></i></a> ";
                                    echo "<a class='confirmation btn btn-danger'  href=\"delete_bank_account.php?id=" . $row['account_id'] . "\" ><i class='fas fa-trash'></i></a></td>";
