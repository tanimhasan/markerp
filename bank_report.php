                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">All Information</h3><br>

                            <div class="form-group">

                                <form action="bank_report_print.php" id="quickForm" method="post" target="_blank">
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <!-- text input -->
                                            <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <!-- text input -->
                                            <div class="form-group">
                                                <label for="exampleInputVehicle">Select Account</label>
                                        ...
                                        <div class="col-sm-3">
                                            <!-- text input -->
                                            <div class="form-group">
                                                <label for="exampleInputVehicle">Select Transaction Type</label>
