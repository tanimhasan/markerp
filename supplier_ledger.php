                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">All Supplier Ledger information</h3><br><hr>

                            <div class="form-group">

                                <form action="supplier_ledger_print.php" id="quickForm" method="post" target="_blank">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <!-- text input -->
                                            <div class="form-group">
                                                <label for="exampleInputVehicle">Select Supplier</label>
                                                <select class="form-control select2" name="suppliers_id">
