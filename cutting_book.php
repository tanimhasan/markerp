                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <button type="button" onclick="location.href = 'add_cutting.php';"
                                    class="btn btn-primary float-right"><i class='fas fa-plus-circle'></i> Add New
                            </button>
                            <h3 class="card-title">All Production Details information</h3>
                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                $sql = "SELECT * FROM cutting_book ORDER BY id DESC";
                                ...
                                while ($row = mysqli_fetch_array($result)) {
                                    ...
                                    echo "<td>" .  $row['qty'] . " pcs</td>";
                                    echo "<td>" .  $row['article_no'] . " pcs</td>";
                                    echo "<td>" . date('d F, Y', strtotime($row['date'])) . "</td>";

                                    if ($user_type == 'admin') {

                                        echo "<td><a class='btn btn-primary'  href=\"edit_cutting.php?id=" . $row['id'] . "\" ><i class='fas fa-edit'></i></a></td>";
                                    }
                                    $i++;
