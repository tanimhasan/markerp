      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <li class="nav-item">
                <a href="sales_menu.php" class="nav-link active">
                    <i class="nav-icon fas fa-shopping-bag"></i>
                    <p>
                        Sales
    ...
    <div class="content">
      <div class="container">
          ...
          <div class="container">
              <br><br>
              <div>
                  <button id="my_box" type="button" class="btn btn-danger btn-fill pull-left"><h3>Total Doctors</h3><h1><?php echo $total_dr ;?></h1>
                  </button>
              ...
              <div>
                  <button id="my_box" type="button" class="btn btn-danger btn-fill pull-left"><h3>Total Patient</h3><h1><?php echo $total_patient ;?></h1>
                  </button>
              ...
              <div>
                  <button id="my_box" type="button" class="btn btn-danger btn-fill pull-left"><h3>Total Ambulance</h3><h1><?php echo $total_ambulance ;?></h1>
                  </button>
