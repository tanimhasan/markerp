                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">User Log Info</h3>
                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                $sql = "SELECT * FROM log_info ORDER BY log_id DESC";
                                $result = mysqli_query($con, $sql);
                                $i = 1;
                                while ($row = mysqli_fetch_array($result)) {
                                    echo "<tr>";

                                    /*$res = file_get_contents('https://www.iplocate.io/api/lookup/'.$row['ip_no']);
                                    $res = json_decode($res);*/
                                    ...
                                    /*echo "<td>" . $res->country . ", " . $res->city . "</td>";*/
                                    ...
                                    echo "<td>" . date('d F, Y', strtotime($row['in_time'])) . "</td>";
                                    $i++;
