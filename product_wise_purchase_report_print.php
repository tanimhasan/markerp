...
<div class="invoice-box">
    ...
    <p style="text-align: center;text-style">Product Purchase Report From Date <?php echo $from_date ?>
    ...
    <table>
        ...
        if ($product_id == 'All') {
            $result = mysqli_query($con, "SELECT * FROM purchase_details  WHERE date>='$from_date' AND date<='$to_date'");

        } else {
            $result = mysqli_query($con, "SELECT * FROM purchase_details  WHERE  product_id='$product_id' AND date>='$from_date' AND date<='$to_date'");
        ...
        while ($row = mysqli_fetch_array($result)) {
            ...
            <tr>
                ...
                <td><?php echo supplierName($row['supplier_id']) ?></td>
