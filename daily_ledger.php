                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <button type="button" onclick="location.href = 'add_daily_ledger.php';"
                                    class="btn btn-primary float-right"><i class='fas fa-plus-circle'></i> Add Daily Ledger
                            </button>

                            <h3 class="card-title">Daily Ledger information</h3><br><hr>

                            <div class="form-group">

                                <form action="daily_ledger_print.php" id="quickForm" method="post" target="_blank">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                <div class="form-group">
                                                    <label for="exampleInputAddress">Select Date</label>
                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <th width="10%">Office Amount</th>

                                    <th width="10%">Shop Amount</th>
                                    <th width="10%">Date</th>
                                    <?php
                                ...
                                $sql = "SELECT * FROM daily_ledger ORDER BY id DESC";
                                ...
                                while ($row = mysqli_fetch_array($result)) {
                                    ...
                                    echo "<td>" . $currency . $row['previous_amount'] . "</td>";
                                    echo "<td>" . $currency . $row['office_amount'] . "</td>";
                                    echo "<td>" . $currency . $row['shop_amount'] . "</td>";
                                    echo "<td>" . date('d F, Y', strtotime($row['date'])) . "</td>";

                                    if ($user_type == 'admin') {
                                        echo "<td><a class='btn btn-primary'  href=\"edit_daily_ledger.php?id=" . $row['id'] . "\" ><i class='fas fa-edit'></i></a> </td>";
                                    }
                                    $i++;
        ...
        $("#example1").DataTable({
            ...
            buttons: [
...

                {
                    ...
                    title: '<p align="center">Daily Ledger Report</p>',
                    exportOptions: {
                        columns: [0, 1, 2, 3, 4]
                    }
                },
