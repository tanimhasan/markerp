                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">All Cutting Report</h3><br><hr>

                            <div class="form-group">

                                <form action="cutting_ledger_print.php" id="quickForm" method="post" target="_blank">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <!-- text input -->
                                            <div class="form-group">
                                                <label for="exampleInputEmployee">Select Article No</label>
