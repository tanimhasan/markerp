...
if (isset($id) AND isset($pre_date)) {
    ...
    if ($num_rows > 0) {
        ...
        $insert=mysqli_query($con,"INSERT INTO attendance (`emp_id`,`attendance`,`att_date`) VALUE ('$id','Present','$pre_date')");
// insert access log in to data base
        /*include 'my_function.php';
        $user_id = getIdByEmail($_SESSION['email']);
        insertActivityLog($user_id,'Added Attendance in Present');*/
