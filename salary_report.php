                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">All Salary Information</h3><br>

                            <div class="form-group">

                                <form action="salary_report.php" id="quickForm" method="post">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <!-- text input -->
                                            <div class="form-group">
                        ...
                        <div class="card-body">
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                if ($employee_id == 'all'){
                                    $sql = "SELECT * FROM salary WHERE  timestamp>='$from_date' AND timestamp<='$to_date' ORDER BY timestamp DESC";
                                } else{
                                    $sql = "SELECT * FROM salary WHERE  timestamp>='$from_date' AND timestamp<='$to_date' AND emp_id='$employee_id' ORDER BY timestamp DESC";
                                }
                                ...
                                while ($row = mysqli_fetch_array($result)) {
                                    ...
                                    echo "<td>" . date('d F, Y', strtotime($row['timestamp'])) . "</td>";
