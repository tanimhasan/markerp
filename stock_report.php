                    ...
                    <div class="card">
                        ...
                        <div class="card-header">
                            ...
                            <div class="form-group">
                                ...
                                <form action="stock_report_print.php" id="myform" method="post" target="_blank">
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2" name="product_id"
                                                    ...
                                                    while ($row = mysqli_fetch_array($result)) {
                                                        echo "<option value='" . $row['product_id'] . "'>" . $row['product_name'] . ' ' . $row['last_name'] . "</option>";
