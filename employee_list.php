                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <button type="button" onclick="location.href = 'add_employee.php';"
                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped" style="width:100%">
                                ...
                                if ($user_type == 'admin') {
                                    echo "<td><a class='btn btn-primary'  href=\"edit_employee.php?id=" . $row['employee_id'] . "\" ><i class='fas fa-edit'></i></a> ";
                                    echo "<a class='confirmation btn btn-danger'  href=\"delete_employee.php?id=" . $row['employee_id'] . "\" ><i class='fas fa-trash'></i></a></td>";
