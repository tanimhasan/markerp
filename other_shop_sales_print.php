...
<head>
    <meta charset="utf-8"/>
    <title>Other Shop Sales Report</title>
...
<div class="invoice-box">
                ...
                <table>
                    <tr>
                        <td class="title">
                            ...
                            <p><?php echo otherShopName($shop_id); ?> Sales Report</p>
                        </td>
    ...
    <table>
        ...
        if ($shop_id=='All')
        {
            $result = mysqli_query($con, "SELECT * FROM other_shop_sales  WHERE oss_date>='$from_date' AND oss_date<='$to_date'");

        }
        else
        {
            $result = mysqli_query($con, "SELECT * FROM other_shop_sales  WHERE  other_shop_id='$shop_id' AND oss_date>='$from_date' AND oss_date<='$to_date'");
        ...
        while ($row = mysqli_fetch_array($result)) {
            ...
            <tr>
                ...
                <td><?php echo date('d F, Y', strtotime($row['oss_date'])) ?></td>
