...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (mysqli_query($con, "UPDATE expense SET expense_name='$expense_name',category_id='$category_id', expense_note='$expense_note',expense_amount='$expense_amount',expense_time='$expense_time',expense_date='$expense_date' WHERE expense_id='$expense_id'")) {
      // insert access log in to data base
      $user_email = $_SESSION['email'];
      $user_id = getIdByEmail($user_email);
      insertActivityLog($user_id,'Updated Expense ' . $expense_name);
                      ...
                      <div class="col-md-6">
                          <div class="form-group">
                              ...
                              <select class="form-control select2" name="category_id">
                                  <option value="<?php echo $row['category_id'] ?>"><?php echo expenseCategoryName($row['category_id']) ?></option>

                                  <?php
                                  $result2 = mysqli_query($con, "SELECT * FROM expense_category");
                  ...
                  <div class="row">
                      <div class="col-md-6">
                          <div class="form-group">
                              ...
                              <?php if (empty($row['expense_time'])){ ?>
                                  <input type="time" name="expense_time" class="form-control" id="exampleInputInTime">
                              <?php }else{ ?>
                                  <input type="text" name="expense_time" class="form-control" id="exampleInputInTime" value="<?php echo strtoupper($row['expense_time']); ?>">
                              <?php } ?>
