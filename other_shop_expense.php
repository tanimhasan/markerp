...
<head>
    ...
    <title>Other Shop Expense Info</title>
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <button type="button" onclick="location.href = 'add_os_expense.php';"
                                    class="btn btn-primary float-right"><i class='fas fa-plus-circle'></i> Add Expense
                            </button>
                            <h3 class="card-title">All Other Shop Expense Information</h3>
                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                $sql = "SELECT * FROM other_shop_expense ORDER BY ose_id DESC";
                                ...
                                while ($row = mysqli_fetch_array($result)) {
                                    ...
                                    echo "<td>" . date('d F, Y', strtotime($row['ose_date'])) . "</td>";
                                    echo "<td>" . $currency . $row['amount'] . "</td>";

                                    if ($user_type=='admin') {
                                        echo "<td><a class='btn btn-primary'  href=\"edit_os_expense.php?id=" . $row['ose_id'] . "\" ><i class='fas fa-edit'></i></a> ";
                                        echo "<a class='confirmation btn btn-danger'  href=\"delete_os_expense.php?id=" . $row['ose_id'] . "\" ><i class='fas fa-trash'></i></a></td>";
                                    }
