...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $result = mysqli_query($con, "SELECT * FROM other_shop_sales WHERE other_shop_id='$shop_id' AND description='$description' AND oss_date='$oss_date' AND amount='$amount'");
    ...
    if ($num_rows > 0) {
        ...
        if (mysqli_query($con, "INSERT INTO other_shop_sales (`other_shop_id`,`description`,`quantity`,`oss_date`,`amount`) VALUE ('$shop_id','$description','$quantity','$oss_date','$amount')")) {

            // insert access log in to data base
            include('my_function.php');
            $user_email = $_SESSION['email'];
            $user_id = getIdByEmail($user_email);
            insertActivityLog($user_id,'Added Other Shop Sales ' . otherShopName($shop_id));
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <form role="form" id="quickForm" method="post" action="add_os_sales.php">
                            <div class="card-body">
                            ...
                            <div class="card-footer">
                                ...
                                <button type="submit" id="add_sales" class="btn btn-primary"><i class="fa fa-check-circle"></i> Add Sales
                                </button>
                            </div>
                        </form>
