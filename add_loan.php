...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $result = mysqli_query($con, "SELECT * FROM loan where name='$name' AND loan='$loan' AND notes='$notes' AND  status='$status' AND  date='$date'");
    $num_rows = mysqli_num_rows($result);


    if ($num_rows > 0) {
        echo '<script type="text/javascript">';
        echo 'setTimeout(function () { swal.fire("ERROR!","Loan already exists!","error");';
        echo '}, 500);</script>';
    } else {
        if (mysqli_query($con, "INSERT INTO loan (`loan`,`name`,`notes`,`status`,`date`) VALUE ('$loan','$name','$notes','$status','$date')")) {
            // insert access log in to data base
            include('my_function.php');
            $user_email = $_SESSION['email'];
            $user_id = getIdByEmail($user_email);
            insertActivityLog($user_id,'Added Loan ' . $name);
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <form role="form" id="quickForm" method="post" action="add_loan.php">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="exampleInputloan">loan</label>
                                            <input type="number" name="loan" class="form-control" id="exampleInputloan"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea name="notes" class="form-control" id="exampleInputNotes"
                                                      placeholder="Write Notes.." style="height:100px"></textarea>
                                        </div>
                                    </div>
                            ...
                            <div class="card-footer">
                                ...
                                <button type="submit" id="add_loan" class="btn btn-primary"><i
                                        class="fa fa-check-circle"></i> Add Loan
                                </button>
                            </div>
                        </form>
