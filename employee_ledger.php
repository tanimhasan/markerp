                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Employee Ledger information</h3><br><hr>

                            <div class="form-group">

                                <form action="employee_ledger_print.php" id="quickForm" method="post" target="_blank">
                                    <div class="row">
                        ...
                        <div class="card-header">
                            <h3 class="card-title">All Employee Ledger information</h3><br><hr>

                            <div class="form-group">

                                <form action="all_employee_ledger_print.php" id="quickForm" method="post" target="_blank">
                                    <div class="row">
