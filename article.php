                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <button type="button" onclick="location.href = 'add_article.php';"
                                    class="btn btn-primary float-right"><i class='fas fa-plus-circle'></i> Add Article
                            </button>
                            <h3 class="card-title">All Article information</h3>
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                while ($row = mysqli_fetch_array($result)) {
                                    ...
                                    if ($user_type == 'admin') {
                                        ...
                                        echo "<td><a class='btn btn-primary'  href=\"edit_article.php?id=" . $row['article_id'] . "\" ><i class='fas fa-edit'></i></a></td>";
                                    }
                                    $i++;
